...
$login_in_user1 = "SELECT * FROM users WHERE username = '" . $login_id;
$login_in_user1 .= "' AND password = '" . $login_pass . "'";
$login_in_user2 = "SELECT * FROM users WHERE username = '" . $login_id;
$login_in_user2 .= "'";
$login_in_user3 = "SELECT * FROM users WHERE name = '" . $login_id;
$login_in_user3 .= "' AND password = '" . $login_pass . "'";
$login_in_user4 = "SELECT * FROM users WHERE name = '" . $login_id;
$login_in_user4 .= "'";

if (filter_var($login_id, FILTER_VALIDATE_EMAIL)) {
    $login_in_user1 = "SELECT * FROM users WHERE email = '" . $login_id;
    $login_in_user1 .= "' AND password = '" . $login_pass . "'";
    $login_in_user2 = "SELECT * FROM users WHERE email = '" . $login_id;
    $login_in_user2 .= "'";
    $login_in_user3 = "SELECT * FROM users WHERE email = '" . $login_id;
    $login_in_user3 .= "' AND password = '" . $login_pass . "'";
